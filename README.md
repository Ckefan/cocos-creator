...
### **主要组件的使用**
<span  id="sprite"><a src="http://docs.cocos.com/creator/manual/zh/components/sprite.html">1. sprite 图层精灵组件</a></span><br>
...
<span  id="sprite"><a src="http://docs.cocos.com/creator/manual/zh/components/animation.html">2. animation 动画组件</a></span><br>
...
<span  id="label"><a src="http://docs.cocos.com/creator/manual/zh/components/label.html">3. label 文字渲染组件</a></span><br>
...
<span  id="mark"><a src='http://docs.cocos.com/creator/manual/zh/components/mask.html'>4. mark 遮罩组件</a></span><br>
